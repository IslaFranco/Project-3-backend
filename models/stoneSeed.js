...
module.exports = [
    ...
    {
        name: 'Citrine',
        description: 'Sweet Citrine is here to remind you that when life gives you lemons, make lemonade. Highly coveted since ancient times, this gleaming gem is known for sharing the power of positivity, inviting abundance into your path, and granting you that emotional dose of vitamin D for the perfect pick me up. If you have been feeling like winter vibes are weighing heavy on your soul, make space for Citrine.',
        img: 'https://miro.medium.com/max/1000/1*xdDEn6_CBEIoar3-dSZw_A.jpeg',
        color: 'Light Clear Yellow',
    },
    {
        name: 'Bloodstone',
        description: 'Bloodstone is here to make your blood pump, to keep your heart strong, and to lend weight and trust to your own levels of intuition. It does all of this by working across the body, mind, and soul. Bloodstone was once used on the battlefield to staunch wounds and has a deep mystical history as it was said to have formed from the blood of Christ. Everything points towards this gem having deep divine powers and the ability to infuse your sense of self with power, courage, and protection.',
        img: 'https://cdn11.bigcommerce.com/s-zdj0fkomub/images/stencil/1280x1280/products/292/676/4E2CE5F2-1376-4BE1-9F05-1BF841199EF9__57968.1620226330.jpg?c=1',
        color: 'Red, Green, and Brown',
    },
    {
        name: 'Smoky Quarts',
        description: 'Smoky Quartz tumbled stones come laced in love. These protective little gems can be easily stashed on your person or in a place and are always ready to keep bad energy at bay. For those who find themselves sensitive to electromagnetic smog, you can rest these gems in between you and your technology - creating a barrier that keeps you cloaked. This does not just work on EMFs but all kinds of harmful vibes that want to interfere with your energy.',
        img:'https://cdn.shopify.com/s/files/1/2137/3195/products/image_69afb0bb-6f8c-4b75-8d2a-d161952f9a5c_grande.jpg?v=1580859411',
        color: 'Mix of Clear White and Black',
    },
    {
        name: 'Amethyst',
